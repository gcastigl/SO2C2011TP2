...
Pci_Vendor_Type PciVenTable [] =
{
	...
	{ 0x1000, "LSI", "LSI Logic 53C1030 Device" } ,
...
#define	PCI_VENDOR_LEN	(sizeof(PciVenTable)/sizeof(Pci_Vendor_Type))
...
Pci_Device_Type PciDevTable[] = 
{
    ...
    {	 0x1002	,	 0x4393	, "ATI ?", "AHCI/Raid Controller" } ,
    ...
    {	 0x1002	,	 0x7145	, "x1400", "PCIEN_1002&DEV_7145&SUBSYS_20031028&REV_00\4&1C9EC085&0&0008" } ,
    ...
    {	 0x1002	,	 0x71D2	, "FireGL V3400", "FireGL V3400" } ,
    ...
    {	 0x102B	,	 0x0522	, "MGA-G200E", "Matrox G200e (ServerEngines)" } ,
    ...
    {	 0x104C	,	 0x8400	, "????", "D-Link AirPlus DWL-520+, Uses a TI 802.11b 22 MBPS Chip" } ,
    ...
    {	 0x104C	,	 0xAC13	, "PCI9440", "PCIVEN_104C&DEV_803B&SUBSYS_00011179&REV_00\4&6B16D5B&0&5AF0 " } ,
    ...
    {	 0x1057	,	 0x3055	, "sm56", "Modem w speakerphone" } ,
    {	 0x1057	,	 0x3057	, "HDAUDIO FUNC_02 VEN_1057 DEV_3057 SUBSYS_00010001", "Modem Device on High Definition Audio Bus" } ,
    ...
    {	 0x1095	,	 0x3112	, "1205SA", "Adaptec 1205SA" } ,
    ...
    {	 0x109E	,	 0x036e	, "878a", "25878-13" } ,
    {	 0x109E	,	 0x036E	, "Bt878 Mediastream Controller", "Brooktree Corp" } ,
    {	 0x109E	,	 0x036E	, "878Asad", "SVR-2000 V1.02" } ,
    {	 0x109E	,	 0x036E	, "CONEXANT FUSION 878A 25878-13 E349764.7", "conexant 878a" } ,
    ...
    {	 0x10AB	,	 0x1005	, "USBVID_0000&PID_0000\5&5657949&0&8", "USB Bluetooth" } ,
    ...
    {	 0x10B5	,	 0x8111	, "PEX 8311", "PCI Express-to-PCI Bridge" } ,
    ...
    {	 0x10B7	,	 0x0013	, "3com p/n: 3CRDAG675", "3Comï¿½ 11a/b/g Wireless PCI Adapter " } ,
    ...
    {	 0x10B9	,	 0x5461	, "SW\{CD171DE3-69E5-11D2-B56D-0000F8754380}\{9B36589", "Microsoft UAA Bus Driver for High Definition Audio" } ,
    ...
    {	 0x10DC	,	 0x0301	, "PLX PCI 9030", "based on the PLX PCI 9030 to build a MIL1553 bus interface" } ,
    ...
    {	 0x10DE	,	 0x0371	, "ADI 1988", "8 Channel High Definition Audio" } ,
    ...
    {	 0x10DE	,	 0x0649	, "nVidia", "nVidia GeForce 9600M GT" } ,
    ...
    {	 0x10E8	,	 0x4750	, "S5920Q 0048 A023", "amcc PCI MatchMaker" } ,
    ...
    {	 0x10EC	,	 0x8101	, "8101E", "10/100 Ethernet" } ,
    ...
    {	 0x10EC	,	 0x8136	, "RTL8100-8101E-8102E-PCIEXPRESS", "Realtek 8139/810x Family Fast Ethernet NIC" } ,
    ...
    {	 0x10EC	,	 0x8168	, "RTL8111/8168", "Gigabit Ethernet LOM" } ,
    ...
    {	 0x1103	,	 0x0004	, "HPT366/368", "ATA Raid Controller" } ,
    {	 0x1103	,	 0x0005	, "HPT370/372", "ATA Raid Controller" } ,
    ...
    {	 0x1131	,	 0x7130	, "73c0a1434628", "Philips SAA7130HL Multimedia Capture Device" } ,
    ...
    {	 0x1131	,	 0x7146	, "saa7146H", "PCIVEN_1131&DEV" } ,
    ...
    {	 0x1179	,	 0x0805	, "PCIVEN_1180&DEV_0592&SUBSYS_828D1033&REV_06\4&5A9", "SD Card Controller" } ,
    {	 0x1179	,	 0x0D01	, "0x0D01", "FIR Port Type-O" } ,
    {	 0x1179	,	 0x1179	, "0x1179", "pci communication device" } ,
    ...
    {	 0x1191	,	 0x000B	, "AEC6897", "ACARD AEC-6897 RAID Controller" } ,
    ...
    {	 0x11AB	,	 0x4351	, "88E8039", "Yukon PCI-E Fast Ethernet Controller" } ,
    ...
    {	 0x11AB	,	 0x436b	, "?", "Gigabit Ethernet" } ,
    ...
    {	 0x11AB	,	 0xFF93	, "88E8055", "Marvell Yukon 88E8055 PCI-E Gigabit Ethernet Controller" } ,
    ...
    {	 0x1319	,	 0x0322	, "fm801-au", "PCI Audio" } ,
    ...
    {	 0x13F0	,	 0x13F0	, "-PCIVEN_13F0&DEV_1023&SUBSYS_81801043&REV_41\4&BC", "ST201 Fast Ethernet Adapter" } ,
    {	 0x13F6	,	211	, "pcnet ht2001 9932", "serlio" } ,
    ...
    {	 0x14E4	,	 0x165A	, "94309", "Broadcom Gigabit Ethernet (HP ML110 G5)" } ,
    ...
    {	 0x14E4	,	 0x4315	, "BCM4312", "Broadcom Wireless " } ,
    ...
    {	 0x14F1	,	 0x5045	, "1179FF31", "Conextant HD Audio Device" } ,
    ...
    {	 0x1523	,	 0x0008	, "MU9C8K64", "Content Addressable Memory" } ,
    ...
    {	 0x168C	,	 0x001c	, "Asus VX2S", " Wireless network adapter" } ,
    ...
    {	 0x8086	,	 0x0283	, "AA", "Intel(R) ICH8 Family SMBus Controller" } ,
    ...
    {	 0x8086	,	 0x10F5	, "82567LM", "Intel®  45 Express-Chipsatz" } ,
    ...
    {	 0x8086	,	 0x1227	, "82865g", "LAN Controller with 82562EM/EX PHY	PCI" } ,
    ...
    {	 0x8086	,	 0x266D	, "82801DB", "Carte audio Analog Devices AD1981HD @ Intel 8280 DB ICH4 - AC97 audio controleur" } ,
    ...
    {	 0x8086	,	 0x27d8	, "PCIVEN_8086&DEV_27D8&SUBSYS_02201028&REV_01\3&172", "Microsoft UAA Bus HD Audio" } ,
    ...
    {	 0x8086	,	 0x2914	, "", "Intel Corporation 82801I0 (ICH9D0) LPC Interface Controller (rev 02)" } ,
    ...
    {	 0x8086	,	 0x2934	, "", "Intel Corporation 82801I (ICH9) USB UHCI Controller # 1 (rev 02)"},
    {	 0x8086	,	 0x2935	, "", "Intel Corporation 82801I (ICH9) USB UHCI Controller # 2 (rev 02)"},
    {	 0x8086	,	 0x2936	, "", "Intel Corporation 82801I (ICH9) USB UHCI Controller # 3 (rev 02)"},
    {	 0x8086	,	 0x2937	, "", "Intel Corporation 82801I (ICH9) USB UHCI Controller # 4 (rev 02)" },
    {	 0x8086	,	 0x2938	, "", "Intel Corporation 82801I (ICH9) USB UHCI Controller # 5 (rev 02)"},
    {	 0x8086	,	 0x293a	, "", "Intel Corporation 82801I (ICH9) USB2 EHCI Controller # 1 (rev 02)"},
    {	 0x8086	,	 0x293c	, "", "Intel Corporation 82801I (ICH9) USB2 EHCI Controller # 2 (rev 02)"},
    {	 0x8086	,	 0x293E	, "486486", "Microsoft UAA Bus Driver for High Definition Audio" } ,
    {	 0x8086	,	 0x2940	, "", "Intel Corporation 82801I (ICH9 Family) PCI Express Port 1 (rev 02)" } ,
    ...
    {	 0x8086	,	 0x29C2	, "G33/G31", "Intel(R) G33/G31 Express Chipset Family" } ,
    {	 0x8086	,	 0x29D4	, "82801", "Intel Management Interface" } ,
    {	 0x8086	,	 0x2A02	, "Unknown", "Intel GM965" } ,
    {	 0x8086	,	 0x2A03	, "82Q965", "Intel GM965" } ,
    ...
    {	 0x8086	,	 0x7180	, "intel 82801 IB ICH7 - high definition audio", "Host/PCI bridge in 440LX/EX AGP chipset" } ,
...
#define	PCI_DEVICE_LEN	(sizeof(PciDevTable)/sizeof(Pci_Device_Type))

void getVenDevStr (unsigned int venCode,unsigned int devCode,char ** venStr,char **devStr);
