...
/**
   ...
   It can store anything that can be cast to a void* -- so a int, or any pointer.
**/
typedef void* type_t;
/**
...
ordered_array_t place_ordered_array(void *addr, int max_size, lessthan_predicate_t less_than);
